...
var decimalWithNoLeadingDigits = "\\.\\d{1,256}";
var integerWithOptionalDecimal = `\\d{1,3}(${decimalWithNoLeadingDigits})?`;
var singleCoordinate = `(-?(${integerWithOptionalDecimal}|${decimalWithNoLeadingDigits}))`;
var COORDINATE_QUERY_REGEX = new RegExp(`^[ ]*${singleCoordinate},\\s*${singleCoordinate}[ ]*$`);
var SPACES_OR_COMMA_REGEX = /[\s,]+/;
var _getQueryParams2;
var getQueryParams_fn2;
var _convertReverseResponsetoSuggestionResponse;
var convertReverseResponsetoSuggestionResponse_fn;
var _convertSearchBoxFeaturetoSuggestion;
var convertSearchBoxFeaturetoSuggestion_fn;
var _SearchBoxCore = class {
  constructor(options = {}) {
    __privateAdd(this, _getQueryParams2);
    __privateAdd(this, _convertReverseResponsetoSuggestionResponse);
    __privateAdd(this, _convertSearchBoxFeaturetoSuggestion);
    const _a = options, { accessToken } = _a, defaults = __objRest(_a, ["accessToken"]);
    this.accessToken = accessToken;
  ...
  suggest(searchText, optionsArg) {
    return __async(this, null, function* () {
      ...
      if (isReverseQuery && optionsArg.allowReverse) {
        let coordinates = searchText.trim().split(SPACES_OR_COMMA_REGEX).map((part) => part.trim());
        if (optionsArg.flipCoordinates) {
          coordinates = coordinates.reverse();
        }
        const coordinatesString = coordinates.join(",");
        const reverseResponse = yield this.reverse(coordinatesString, optionsArg);
        return __privateMethod(this, _convertReverseResponsetoSuggestionResponse, convertReverseResponsetoSuggestionResponse_fn).call(this, reverseResponse);
      }
      const { sessionToken, signal } = optionsArg;
      const options = __spreadProps(__spreadValues(__spreadValues({}, this.defaults), optionsArg), {
        q: searchText,
      ...
      const json = yield res.json();
      json.url = url.toString();
      (_a = json.suggestions) == null ? void 0 : _a.forEach((suggestion) => {
  ...
  reverse(_0) {
    return __async(this, arguments, function* (lngLat, optionsArg = {}) {
      ...
      const json = yield res.json();
      json.url = url.toString();
      (_a = json.features) == null ? void 0 : _a.forEach((feature) => {
...
_convertReverseResponsetoSuggestionResponse = /* @__PURE__ */ new WeakSet();
convertReverseResponsetoSuggestionResponse_fn = function(response) {
  return {
    suggestions: response.features.map((feature) => {
      return __privateMethod(this, _convertSearchBoxFeaturetoSuggestion, convertSearchBoxFeaturetoSuggestion_fn).call(this, feature, response.url);
    }),
    attribution: response.attribution,
    url: response.url
  };
};
_convertSearchBoxFeaturetoSuggestion = /* @__PURE__ */ new WeakSet();
convertSearchBoxFeaturetoSuggestion_fn = function(feature, responseUrl) {
  return __spreadProps(__spreadValues({}, feature.properties), {
...
var MapboxSearchListbox = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd2(this, _handleFocusOut, (event) => {
      if (!__privateGet2(this, _binding).MapboxSearch.contains(event.relatedTarget)) {
        this.hideResults();
      }
    });
    this.handleArrowUp = () => {
  ...
  connectedCallback() {
    ...
    Results.addEventListener("focusout", __privateGet2(this, _handleFocusOut));
  ...
  disconnectedCallback() {
    this.input = null;
    const { Results } = __privateGet2(this, _binding);
    Results.removeEventListener("focusout", __privateGet2(this, _handleFocusOut));
    if (__privateGet2(this, _popover))
      __privateGet2(this, _popover).destroy();
  }
  focus() {
...
_handleFocusOut = /* @__PURE__ */ new WeakMap();
  ...
  constructor() {
    ...
    __privateAdd2(this, _handleObserve, () => {
      ...
      try {
        ...
        if (input) {
          input.addEventListener("blur", __privateGet2(this, _onHandleInputBlur));
        }
      } catch (e) {
    ...
    __privateAdd2(this, _onHandleInputBlur, (event) => {
      if (!__privateGet2(this, _listbox).contains(event.relatedTarget)) {
        __privateGet2(this, _onHandleBlur).call(this);
...
_onHandleInputBlur = /* @__PURE__ */ new WeakMap();
...
var CORE_COMPONENT_OPTION_KEYS = [
  "allowReverse",
  "flipCoordinates"
];
var _binding5;
...
var _listbox2;
var _eventManager2;
var _componentOptions;
var _getCoreComponentOptions;
...
var MapboxSearchBox = class extends HTMLScopedElement {
  constructor() {
    ...
    this.options = {};
    __privateAdd2(this, _componentOptions, __spreadValues2({}, DEFAULT_COMPONENT_OPTIONS));
    __privateAdd2(this, _getCoreComponentOptions, () => {
      const options = __spreadValues2({}, this.componentOptions);
      for (const key in options) {
        if (CORE_COMPONENT_OPTION_KEYS.indexOf(key) === -1) {
          delete options[key];
        }
      }
      return options;
    ...
    __privateAdd2(this, _handleSuggest2, (result) => __async2(this, null, function* () {
      __privateGet2(this, _setActionIcons).call(this);
      let suggestions = null;
      if (this.componentOptions.customSearch) {
        const customFeatures = yield this.componentOptions.customSearch(this.value);
      ...
      __privateGet2(this, _listbox2).handleSuggest(suggestions || null);
      if (!__privateGet2(this, _binding5).SearchBox.contains(document.activeElement)) {
        this.focus();
      }
      this.dispatchEvent(new MapboxHTMLEvent("suggest", result));
    }));
    __privateAdd2(this, _handleSuggestError2, (error) => __async2(this, null, function* () {
      __privateGet2(this, _setActionIcons).call(this);
      if (this.componentOptions.customSearch) {
        const customFeatures = yield this.componentOptions.customSearch(this.value);
        if (customFeatures && customFeatures.length) {
          ...
          __privateGet2(this, _listbox2).handleSuggest(customFeatures || null);
        } else {
    ...
    __privateAdd2(this, _handleRetrieve2, (result) => {
      ...
      if (this.componentOptions.flyTo) {
        __privateGet2(this, _fly).call(this, feature);
      }
    ...
    __privateAdd2(this, _onHandleInput2, (e) => {
      ...
      __privateGet2(this, _session2).suggest(searchText, __spreadValues2(__spreadValues2({}, this.options), __privateGet2(this, _getCoreComponentOptions).call(this)));
    ...
    __privateAdd2(this, _onHandleFocusOut, (event) => {
      if (!__privateGet2(this, _binding5).SearchBox.contains(event.relatedTarget) && !__privateGet2(this, _listbox2).contains(event.relatedTarget)) {
        __privateGet2(this, _onHandleBlur2).call(this);
        __privateGet2(this, _listbox2).hideResults();
        this.dispatchEvent(new MapboxHTMLEvent("blur"));
      }
    });
    ...
    __privateAdd2(this, _fly, (feature) => {
      const map = __privateGet2(this, _map);
      if (!map) {
        return;
      }
      ...
      if (bounds) {
        flyToOptions = bboxViewport(map, LngLatBounds.convert(bounds).toFlatArray());
      } else {
  ...
  get componentOptions() {
    return __privateGet2(this, _componentOptions);
  }
  set componentOptions(options) {
    __privateSet2(this, _componentOptions, __spreadValues2(__spreadValues2({}, DEFAULT_COMPONENT_OPTIONS), options));
  }
  get theme() {
  ...
  connectedCallback() {
    ...
    const { Input, ClearBtn, SearchBox: SearchBox2 } = __privateGet2(this, _binding5);
    SearchBox2.addEventListener("focusout", __privateGet2(this, _onHandleFocusOut));
  ...
  disconnectedCallback() {
    const { SearchBox: SearchBox2 } = __privateGet2(this, _binding5);
    SearchBox2.removeEventListener("focusout", __privateGet2(this, _onHandleFocusOut));
...
_componentOptions = /* @__PURE__ */ new WeakMap();
_getCoreComponentOptions = /* @__PURE__ */ new WeakMap();
...
var MAX_ZOOM2 = 9;
var DEFAULT_COMPONENT_OPTIONS2 = {
  flyTo: true
};
var CORE_COMPONENT_OPTION_KEYS2 = [
  "flipCoordinates"
];
var _binding6;
var _search2;
...
var _listbox3;
var _eventManager3;
var _componentOptions2;
var _getCoreComponentOptions2;
...
var MapboxGeocoder = class extends HTMLScopedElement {
  constructor() {
    ...
    this.options = {};
    __privateAdd2(this, _componentOptions2, __spreadValues2({}, DEFAULT_COMPONENT_OPTIONS2));
    __privateAdd2(this, _getCoreComponentOptions2, () => {
      const options = __spreadValues2({}, this.componentOptions);
      for (const key in options) {
        if (CORE_COMPONENT_OPTION_KEYS2.indexOf(key) === -1) {
          delete options[key];
        }
      }
      return options;
    ...
    __privateAdd2(this, _handleSuggest3, (result) => __async2(this, null, function* () {
      ...
      __privateGet2(this, _listbox3).handleSuggest(features || null);
      if (!__privateGet2(this, _binding6).Geocoder.contains(document.activeElement)) {
        this.focus();
      }
      this.dispatchEvent(new MapboxHTMLEvent("suggest", result));
    }));
    __privateAdd2(this, _handleSuggestError3, (error) => __async2(this, null, function* () {
      __privateGet2(this, _setActionIcons2).call(this);
      if (this.componentOptions.customSearch) {
        const customFeatures = yield this.componentOptions.customSearch(this.value);
        if (customFeatures && customFeatures.length) {
          ...
          __privateGet2(this, _listbox3).handleSuggest(customFeatures || null);
        } else {
    ...
    __privateAdd2(this, _handleRetrieve3, (result) => {
      ...
      if (this.componentOptions.flyTo) {
        __privateGet2(this, _fly2).call(this, feature);
      }
      if (this.marker && this.mapboxgl) {
    ...
    __privateAdd2(this, _onHandleInput3, (e) => {
      ...
      __privateGet2(this, _session3).suggest(searchText, __spreadValues2(__spreadValues2({}, this.options), __privateGet2(this, _getCoreComponentOptions2).call(this)));
    ...
    __privateAdd2(this, _onHandleFocusOut2, (event) => {
      if (!__privateGet2(this, _binding6).Geocoder.contains(event.relatedTarget) && !__privateGet2(this, _listbox3).contains(event.relatedTarget)) {
        __privateGet2(this, _onHandleBlur3).call(this);
        __privateGet2(this, _listbox3).hideResults();
        this.dispatchEvent(new MapboxHTMLEvent("blur"));
      }
    });
    ...
    __privateAdd2(this, _fly2, (feature) => {
      const map = __privateGet2(this, _map2);
      if (!map) {
        return;
      }
  ...
  get componentOptions() {
    return __privateGet2(this, _componentOptions2);
  }
  set componentOptions(options) {
    __privateSet2(this, _componentOptions2, __spreadValues2(__spreadValues2({}, DEFAULT_COMPONENT_OPTIONS2), options));
  }
  get theme() {
  ...
  connectedCallback() {
    ...
    this.theme = __spreadValues2({}, this.theme);
    const { Input, ClearBtn, Geocoder: Geocoder2 } = __privateGet2(this, _binding6);
    Geocoder2.addEventListener("focusout", __privateGet2(this, _onHandleFocusOut2));
  ...
  disconnectedCallback() {
    const { Geocoder: Geocoder2 } = __privateGet2(this, _binding6);
    Geocoder2.removeEventListener("focusout", __privateGet2(this, _onHandleFocusOut2));
...
_componentOptions2 = /* @__PURE__ */ new WeakMap();
_getCoreComponentOptions2 = /* @__PURE__ */ new WeakMap();
...
var MapboxAddressMinimap = class extends HTMLScopedElement {
  ...
  connectedCallback() {
    ...
    this.theme = __spreadValues2({}, this.theme);
    if (__privateGet2(this, _canAdjustMarkerInternal) && !__privateGet2(this, _binding7).EditButtons) {
      __privateGet2(this, _addMarkerEditControls).call(this);
    }
    if (__privateGet2(this, _satelliteToggleInternal) && !__privateGet2(this, _binding7).MapStyleToggle) {
...
_onHandleInputBlur2 = /* @__PURE__ */ new WeakMap();
...
var SearchBox = import_react2.default.forwardRef((props, refProp) => {
  ...
  (0, import_react2.useEffect)(() => {
    if (ref.current)
      ref.current.componentOptions = componentOptions || {};
  }, [ref.current, componentOptions]);
  (0, import_react2.useEffect)(() => {
    if (ref.current)
      ref.current.interceptSearch = interceptSearch;
  ...
  (0, import_react2.useEffect)(() => {
    ...
    return () => {
      node.removeEventListener("blur", fn);
    };
  }, [ref.current, onBlur]);
  (0, import_react2.useEffect)(() => {
    if (ref.current)
