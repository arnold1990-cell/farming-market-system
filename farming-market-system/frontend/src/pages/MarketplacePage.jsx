...
export default function MarketplacePage() {
  ...
  return <AppLayout title="Market" showSearch searchValue={q} onSearchChange={(e) => setQ(e.target.value)}><ToastStack toasts={toasts} onClose={(id) => setToasts((prev) => prev.filter((t) => t.id !== id))} /><div className="space-y-4"><SearchBar value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search by product name" />
