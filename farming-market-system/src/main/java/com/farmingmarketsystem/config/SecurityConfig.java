    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/health", "/api/farmers").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/products", "/api/products/*", "/api/products/public", "/api/products/public/*", "/api/categories", "/api/reviews/products/*", "/uploads/**").permitAll()
                        ...
                        .requestMatchers("/api/farmer/**", "/api/products/my-products", "/api/products/farmer/dashboard", "/api/orders/farmer", "/api/products/*/images", "/api/products/*/images/reorder", "/api/products/images/*", "/api/products/*/orders", "/api/products/*/availability", "/api/payments/cash/**").hasAnyRole("FARMER","ADMIN")
